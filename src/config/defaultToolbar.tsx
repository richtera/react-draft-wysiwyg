...
const bold = require('../../images/bold.svg');
const italic = require('../../images/italic.svg');
const underline = require('../../images/underline.svg');
const strikethrough = require('../../images/strikethrough.svg');
const monospace = require('../../images/monospace.svg');
const fontSize = require('../../images/font-size.svg');
const indent = require('../../images/indent.svg');
const outdent = require('../../images/outdent.svg');
const ordered = require('../../images/list-ordered.svg');
const unordered = require('../../images/list-unordered.svg');
const left = require('../../images/align-left.svg');
const center = require('../../images/align-center.svg');
const right = require('../../images/align-right.svg');
const justify = require('../../images/align-justify.svg');
...
const undo = require('../../images/undo.svg');
const redo = require('../../images/redo.svg');
const subscript = require('../../images/subscript.svg');
const superscript = require('../../images/superscript.svg');
...
export default {
  ...
  media: {
    ...
    alignmentEnabled: true,
    uploadCallback: undefined,
    inputAccept: 'image/*,video/*,audio/*,application/x-zip-compressed,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation,application/pdf,application/msword,application/zip,application/x-7z-compressed,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel,application/vnd.visio,application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    defaultSize: {
      height: 'auto',
      width: 'auto',
    },
